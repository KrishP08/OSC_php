...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_FILES["video"])) {
    ...
    if (!in_array($file_extension, $allowed_formats)) {
        $error_message = "Invalid file format. Only MP4, WebM, or AVI allowed.";
...
<head>
    ...
    <title>Upload Course Videos - Online Smart Class</title>
    ...
    <div class="app-container">
        ...
        <main class="main-content">
            ...
            <section class="content">
                <h1 class="page-header">Upload Course Video</h1>
                ...
                <div class="form-container">
                    <form method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="video_title" class="form-input" required>
                        </div>

                        <div class="file-upload-container">
                            <label class="file-upload-label">Select Video:</label>
                            <input type="file" name="video" accept=".mp4, .webm, .avi" class="file-upload-input" required>
                            <p class="format-info">Supported formats: MP4, WebM, AVI</p>
                        </div>
