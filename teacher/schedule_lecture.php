...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($stmt->execute()) {
        $success_message = "Lecture scheduled successfully!";
    } else {
        $error_message = "Error scheduling lecture.";
    }
}
...
<head>
    ...
    <title>Schedule Live Lecture - Online Smart Class</title>
    ...
    <div class="app-container">
        ...
        <main class="main-content">
            ...
            <section class="content">
                <h1 class="page-header">Schedule Live Lecture</h1>
                ...
                <div class="form-container">
                    <form method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="url" name="meeting_link" class="form-input" required placeholder="https://meet.example.com/your-meeting-id">
                        </div>
