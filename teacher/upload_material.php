...
<head>
    ...
    <title>Upload Course Materials - Online Smart Class</title>
    ...
    <div class="app-container">
        ...
        <main class="main-content">
            ...
            <section class="content">
                <h1 class="page-header">Upload Course Material</h1>
                ...
                <div class="form-container">
                    <form method="POST" enctype="multipart/form-data">
                        ...
                        <div class="file-upload-container">
                            <label class="file-upload-label">Select File:</label>
                            <input type="file" name="file" class="file-upload-input" required>
                        </div>
