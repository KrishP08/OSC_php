...
foreach ($quiz_grades as $quiz) {
    ...
    $total_quiz_possible += $quiz['total_questions'];
}

foreach ($assignment_grades as $assignment) {
    if ($assignment['grade'] !== null) {
        $total_assignments_graded++;
        $total_assignment_score += $assignment['grade'];
    }
}

$quiz_average = $total_quiz_possible > 0 ? round(($total_quiz_score / $total_quiz_possible) * 100) : 0;
$assignment_average = $total_assignments_graded > 0 ? round($total_assignment_score / $total_assignments_graded) : 0;
...
<head>
    ...
    <title>My Grades - Online Smart Class</title>
            ...
            <main class="main-content">
                ...
                <div class="grade-summary">
                    <div class="grade-card">
                        <div class="grade-card-title">Overall Average</div>
                        <div class="grade-value"><?php echo $overall_average; ?><span class="grade-percentage">%</span></div>
                    </div>
                    <div class="grade-card">
                        <div class="grade-card-title">Quiz Average</div>
                        <div class="grade-value"><?php echo $quiz_average; ?><span class="grade-percentage">%</span></div>
                    </div>
                    <div class="grade-card">
                        <div class="grade-card-title">Assignment Average</div>
                        <div class="grade-value"><?php echo $assignment_average; ?><span class="grade-percentage">%</span></div>
                    </div>
                </div>
                        ...
                        <tbody>
                            <?php foreach ($quiz_grades as $quiz): ?>
                                <tr>
                                    ...
                                    <td class="grade-score"><?php echo $quiz['score'] . " / " . $quiz['total_questions']; ?></td>
                                    <td class="grade-percentage-cell"><?php echo $quiz['percentage']; ?>%</td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
                    </table>
                ...
                <h2 class="section-title">Assignment Grades</h2>
                        ...
                        <tbody>
                            <?php foreach ($assignment_grades as $assignment): ?>
                                <tr>
                                    ...
                                    <td class="grade-score"><?php echo $assignment['grade'] !== null ? $assignment['grade'] : 'Not Graded'; ?></td>
                                    <td>
                                        <div class="feedback-text">
                                            <?php echo !empty($assignment['feedback']) ? htmlspecialchars($assignment['feedback']) : 'No Feedback'; ?>
                                        </div>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
