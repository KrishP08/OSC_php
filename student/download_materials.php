...
foreach ($materials as $material) {
    ...
    if (!isset($grouped_materials[$course_title])) {
        $grouped_materials[$course_title] = [];
    }
    $grouped_materials[$course_title][] = $material;
}
...
<head>
    ...
    <title>Download Course Materials - Online Smart Class</title>
    ...
    <div class="app-container">
        ...
        <div class="content-wrapper">
            ...
            <main class="main-content">
                <h1 class="page-title">Download Course Materials</h1>

                <?php if (count($materials) > 0): ?>
                    <div class="materials-container">
                        <?php foreach ($grouped_materials as $course_title => $course_materials): ?>
                            <div class="course-card">
                                <div class="course-header">
                                    <h2 class="course-title"><?php echo htmlspecialchars($course_title); ?></h2>
                                </div>
                                    ...
                                    <?php foreach ($course_materials as $material): ?>
                                        <li class="material-item">
                                            ...
                                            <div class="material-details">
                                                <div class="material-name"><?php echo htmlspecialchars($material['file_name']); ?></div>
                                                <a href="<?php echo htmlspecialchars($material['file_path']); ?>" download class="download-link">Download</a>
                                            </div>
                                        </li>
                                    <?php endforeach; ?>
                                </ul>
                ...
                <?php else: ?>
                    <div class="empty-state">
                        <p>No course materials available for your enrolled courses.</p>
                    </div>
                <?php endif; ?>
