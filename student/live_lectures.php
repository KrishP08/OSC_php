...
<body>
    <div class="app-container">
        ...
        <main class="main-content">
            ...
            <section class="lectures-container">
                <h2 class="page-title">Upcoming Live Lectures</h2>

                <?php if (count($lectures) > 0): ?>
                    <ul class="lectures-list">
                        <?php foreach ($lectures as $lecture): ?>
                            <li class="lecture-item">
                                <div class="lecture-icon-container">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <g clip-path="url(#clip0_lecture)">
                                            <path fill-rule="evenodd" clip-rule="evenodd" d="M12 8.25C9.92893 8.25 8.25 9.92893 8.25 12C8.25 14.0711 9.92893 15.75 12 15.75C14.0711 15.75 15.75 14.0711 15.75 12C15.75 9.92893 14.0711 8.25 12 8.25ZM12 14.25C10.7574 14.25 9.75 13.2426 9.75 12C9.75 10.7574 10.7574 9.75 12 9.75C13.2426 9.75 14.25 10.7574 14.25 12C14.25 13.2426 13.2426 14.25 12 14.25ZM18.9103 14.9194C18.5881 15.6812 18.1421 16.3844 17.5903 17.0006C17.3123 17.3014 16.8445 17.3236 16.5393 17.0504C16.2341 16.7772 16.2045 16.3098 16.4728 16.0003C18.5119 13.7236 18.5119 10.2774 16.4728 8.00062C16.289 7.80176 16.2267 7.51926 16.3098 7.26152C16.3928 7.00379 16.6084 6.81084 16.8737 6.75672C17.139 6.7026 17.4129 6.7957 17.5903 7.00031C19.5233 9.1633 20.0372 12.2464 18.9103 14.9194Z" fill="#0d7df2"></path>
                                        </g>
                                        <defs>
                                            <clipPath id="clip0_lecture">
                                                <rect width="24" height="24" fill="white"></rect>
                                            </clipPath>
                                        </defs>
                                    </svg>
                                ...
                                <div class="lecture-details">
                                    <h3 class="lecture-title"><?php echo htmlspecialchars($lecture['title']); ?></h3>
                                    <p class="lecture-course"><?php echo htmlspecialchars($lecture['course_title']); ?></p>
                                    <div class="lecture-time">
                                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path fill-rule="evenodd" clip-rule="evenodd" d="M12 2.25C6.61522 2.25 2.25 6.61522 2.25 12C2.25 17.3848 6.61522 21.75 12 21.75C17.3848 21.75 21.75 17.3848 21.75 12C21.75 6.61522 17.3848 2.25 12 2.25ZM12 20.25C7.44365 20.25 3.75 16.5563 3.75 12C3.75 7.44365 7.44365 3.75 12 3.75C16.5563 3.75 20.25 7.44365 20.25 12C20.25 16.5563 16.5563 20.25 12 20.25ZM12 6.75C12.4142 6.75 12.75 7.08579 12.75 7.5V11.25H16.5C16.9142 11.25 17.25 11.5858 17.25 12C17.25 12.4142 16.9142 12.75 16.5 12.75H12C11.5858 12.75 11.25 12.4142 11.25 12V7.5C11.25 7.08579 11.5858 6.75 12 6.75Z" fill="#61758a"/>
                                        </svg>
                                        <?php
                                            $date = new DateTime($lecture['scheduled_at']);
                                            echo htmlspecialchars($date->format('F j, Y - g:i A'));
                                        ?>
                                    </div>
                                    <a href="<?php echo htmlspecialchars($lecture['meeting_link']); ?>" target="_blank" class="join-button">
                                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path fill-rule="evenodd" clip-rule="evenodd" d="M4.5 5.25L19.5 12L4.5 18.75V5.25Z" fill="white"/>
                                        </svg>
                                        Join Lecture
                                    </a>
                                </div>
                ...
                <?php else: ?>
                    <div class="no-lectures">
                        <p>No upcoming lectures scheduled at this time.</p>
                    </div>
                <?php endif; ?>
